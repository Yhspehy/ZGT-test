...
export function mockData(areaList: AreaSettingInfo[]) {
  ...
  for (let i = 0; i < areaList.length; i++) {
    ...
    result.push({
      ...
      ARE_BAYWAY: areaInfo.ARE_ROWWAY,
      ARE_ROWWAY: "UD",
      yardBayesInfo,
    });
  }
